...
<div class="main-visual-container">
  <img class="image" src="http://electricalworkshopsite.local/wp-content/uploads/2023/01/main-sample.png" alt="メイン画像①">
    <!--　＊プラグインで３枚のスライド画像  -->
</div>
  ...
  <div id="works" class="works-container">
    ...
    <div class="works-box1">
      <div class="works-item">
        <div class="works-img"><img src="http://electricalworkshopsite.local/wp-content/uploads/2023/01/works-sample.png" alt="施工写真①"></div>
        <div class="works-text">現場名①</div>   
        </div>    
        <div class="works-item">
        <div class="works-img"><img src="http://electricalworkshopsite.local/wp-content/uploads/2023/01/works-sample.png" alt="施工写真②"></div>
        <div class="works-text">現場名②</div> 
